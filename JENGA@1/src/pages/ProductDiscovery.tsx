    ...
    const fetchProducts = async () => {
      ...
      try {
        ...
        if (selectedCategoryId) {
          ...
          // Try to find matching category from hierarchy for display name
    ...
    return cats.map((cat) => {
      ...
      return (
        <div key={cat.id}>
          ...
          >
            {hasChildren ? (
              <span className="text-gray-400" onClick={(e) => { e.stopPropagation(); toggleParent(cat.id); }}>
                {isExpanded ? (
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className="md:hidden flex items-center gap-1.5 px-3 py-2 rounded-lg border border-gray-200 bg-white text-sm text-gray-700"
          >
      ...
      {selectedCategoryName && (
        <div className="flex items-center gap-2 mb-4">
          <span className="inline-flex items-center gap-1 px-3 py-1 rounded-full bg-jenga-50 text-jenga-700 text-sm font-medium">
            {selectedCategoryName}
            <button onClick={handleClearCategory} className="hover:text-jenga-900">
